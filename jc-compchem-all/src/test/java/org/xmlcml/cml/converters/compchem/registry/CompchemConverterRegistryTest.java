...
import org.xmlcml.cml.converters.compchem.registry.CompchemConverterRegistry;
...
public class CompchemConverterRegistryTest {
    ...
    @Test
    public void testMap() {
    	Map<TypePair, List<Converter>> map = CompchemConverterRegistry.getDefaultConverterRegistry().getMap();
    ...
    public void testList() {
    	List<Converter> converterList = CompchemConverterRegistry.getDefaultConverterRegistry().getConverterList();
    ...
    public void testFindConverter() {
    	List<Converter> converters = CompchemConverterRegistry.getDefaultConverterRegistry().findConverters(
    			AmberModule.FF_XML_TYPE.getMimeType(), CMLCommon.CML_TYPE.getMimeType());
    ...
    public void testFindConverter1() {
    	List<Converter> converters = CompchemConverterRegistry.getDefaultConverterRegistry().findConverters(CML, CML);
...
//    	}
	...
	public void testRegistryLoadsConverterList() {
		List<Converter> list = CompchemConverterRegistry.getDefaultConverterRegistry().getConverterList();
		assertTrue(list.size()>0);
	}

	@Test
	public void testFindFoo2BarConverter() {
		List<Converter> converterList = CompchemConverterRegistry.getDefaultConverterRegistry().findConverters("foo", "bar");
		assertNull(converterList);
	}

	@Test
	public void testFindTypesFromSuffix() {
		Set<MimeType> types = CompchemConverterRegistry.getDefaultConverterRegistry().getTypes("cml");
	...
	public void testFindTypesFromSuffix1() {
		Set<MimeType> types = CompchemConverterRegistry.getDefaultConverterRegistry().getTypes("foo");
		Assert.assertNotNull("get types", types);
	...
	public void testFindSingleTypeFromSuffix() {
		MimeType type = CompchemConverterRegistry.getDefaultConverterRegistry().getSingleTypeFromSuffix("cml");
	...
	public void testSingletonConverterRegistry() {
		Assert.assertNotNull(CompchemConverterRegistry.getDefaultConverterRegistry());
	}
	...
	public void testCreateRegistryList() {
		ConverterRegistry converterRegistry = new CompchemConverterRegistry(CompchemConverterRegistry.class.getClassLoader());
	...
	public void testSingletonConverterRegistryList0() {
		ConverterRegistry converterRegistry = CompchemConverterRegistry.getDefaultConverterRegistry();
		List<Converter> converterList = converterRegistry.getConverterList();
		Assert.assertNotNull(converterList);
