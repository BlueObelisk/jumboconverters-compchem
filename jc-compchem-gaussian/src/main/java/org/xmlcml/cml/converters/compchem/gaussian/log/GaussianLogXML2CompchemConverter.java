...
import org.xmlcml.cml.converters.templates.output.XML2XMLTransformConverter;
...
public class GaussianLogXML2CompchemConverter extends XML2XMLTransformConverter {
	...
	public static GaussianLogXML2CompchemConverter createDefaultConverter() {
		return  new GaussianLogXML2CompchemConverter(BASE_URI, "gaussian2compchem.xml");
	}
...
//					}
	...
	public String getDescription() {
		return "Convert Gaussian Log_XML to CML-compchem";
	}
